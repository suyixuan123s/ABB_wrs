...
base = wd.World(cam_pos=[15, 2.624 - 0.275 + 5, 15], lookat_pos=[-1.726 - 0.35, 2.624 - 0.275, 5.323],
                auto_cam_rotate=False)
mcn_s = mcn.TBM()
# mcn_s.gen_meshmodel().attach_to(base)
rbt_s = rbt.TBMChanger(pos=np.array([-1.726 - 0.35, 2.624 - 0.275, 5.323 + .35]),
                       rotmat=rm.rotmat_from_euler(-math.pi / 2, 0, 0))
