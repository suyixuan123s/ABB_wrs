...
start = time.time()
class GOFA10(mi.ManipulatorInterface):
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6), name='ur5e', enable_cc=True):
        ...
        self.jlc.jnts[1]['loc_pos'] = np.array([0, 0, 0.218])
        self.jlc.jnts[2]['loc_pos'] = np.array([0.15, -0.09515, 0.182])
        self.jlc.jnts[2]['loc_rotmat'] = rm.rotmat_from_euler(.0, .0, .0)
        self.jlc.jnts[2]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.jnts[3]['loc_pos'] = np.array([0, 0.01015, 0.707])
        self.jlc.jnts[3]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.jnts[4]['loc_pos'] = np.array([0.09517, 0.088, 0.111])
        self.jlc.jnts[4]['loc_rotmat'] = rm.rotmat_from_euler(.0, 0, 0)
        self.jlc.jnts[4]['loc_motionax'] = np.array([1, 0, 0])
        self.jlc.jnts[5]['loc_pos'] = np.array([0.54, 0.07693, 0])
        ...
        self.jlc.jnts[7]['loc_pos'] = np.array([0.0326, 0, 0])
...
if __name__ == '__main__':
    ...
    manipulator_instance = GOFA10(enable_cc=True)
