...
class GOFA12(mi.ManipulatorInterface):
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6), name='ur5e', enable_cc=True):
        ...
        self.jlc.jnts[1]['loc_pos'] = np.array([0, 0, 0.214])
        self.jlc.jnts[2]['loc_pos'] = np.array([0, -0.09515, 0.124])
        ...
        self.jlc.jnts[5]['loc_pos'] = np.array([0.437, 0.0755, 0])
        ...
        self.jlc.jnts[7]['loc_rotmat'] = rm.rotmat_from_euler(0, 1.570796325, 0)
        # links
...
if __name__ == '__main__':
    ...
    manipulator_instance = GOFA12(enable_cc=True)
