...
class Fingernails(fi.FingerInterface):
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(4), name='ur5e', enable_cc=True):
        ...
        self.jlc.jnts[1]['loc_rotmat'] = rm.rotmat_from_euler(.0, .0, math.pi/2)
        self.jlc.jnts[1]['loc_motionax'] = np.array([1, 0, 0])
        self.jlc.jnts[2]['loc_pos'] = np.array([0, 0, 0.0445])
        self.jlc.jnts[2]['loc_rotmat'] = rm.rotmat_from_euler(.0, .0, -math.pi/2)
        ...
        self.jlc.jnts[4]['loc_pos'] = np.array([0, 0, 0.0445])
        self.jlc.jnts[4]['loc_motionax'] = np.array([1, 0, 0])
        self.jlc.jnts[4]['loc_rotmat'] = rm.rotmat_from_euler(0, 0, math.pi*0 )
        self.jlc.jnts[5]['loc_pos'] = np.array([0, 0.0085, 0.052])
        self.jlc.jnts[5]['loc_motionax'] = np.array([0, 0, 0])
        self.jlc.jnts[5]['loc_rotmat'] = rm.rotmat_from_euler(0/180*math.pi, 0, math.pi*0 )
        ...
        self.jlc.lnks[1]['mesh_file'] = os.path.join(this_dir, "meshes", "12345.STL")
        self.jlc.lnks[1]['rgba'] = [.7,.7,.7, 1]
        self.jlc.lnks[2]['name'] = "shoulder"
        self.jlc.lnks[2]['loc_pos'] = np.zeros(3)
        self.jlc.lnks[2]['com'] = np.array([.0, -.02, .0])
        self.jlc.lnks[2]['mass'] = 1.95
        self.jlc.lnks[2]['mesh_file'] = os.path.join(this_dir, "meshes", "LINK01.STL")
        self.jlc.lnks[2]['rgba'] = [.2,.2,.2, 1]
        self.jlc.lnks[3]['name'] = "upperarm"
        self.jlc.lnks[3]['loc_pos'] = np.array([.0, .0, .0])
        self.jlc.lnks[3]['com'] = np.array([.13, 0, .1157])
        self.jlc.lnks[3]['mass'] = 3.42
        self.jlc.lnks[3]['mesh_file'] = os.path.join(this_dir, "meshes", "LINK02.STL")
        self.jlc.lnks[3]['rgba'] = [.7,.7,.7, 1]
        self.jlc.lnks[4]['name'] = "forearm"
        self.jlc.lnks[4]['loc_pos'] = np.array([.0, .0, .0])
        self.jlc.lnks[4]['com'] = np.array([.05, .0, .0238])
        self.jlc.lnks[4]['mass'] = 1.437
    ...
    def enable_cc(self):
        super().enable_cc()
        self.cc.add_cdlnks(self.jlc, [0, 1, 2, 3,4,5])
...
if __name__ == '__main__':
    ...
    manipulator_instance = Fingernails(enable_cc=True)
