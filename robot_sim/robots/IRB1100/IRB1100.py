...
class IRB1100(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6), name='ur5e', enable_cc=True):
        ...
        self.jlc.jnts[1]['loc_pos'] = np.array([0, 0, 0.1595])

        self.jlc.jnts[2]['loc_pos'] = np.array([0.0525, 0, 0.1675])
...
# -0.063, 0.0455, 0.010
        ...
        self.jlc.lnks[1]['mesh_file'] = os.path.join(this_dir, "meshes", "IRB1100_4kg-475_OmniCore_rev03_Link01_CAD_j.STL")
        ...
        self.jlc.lnks[2]['mesh_file'] = os.path.join(this_dir, "meshes", "IRB1100_4kg-475_OmniCore_rev03_Link02_CAD_j.sat_2.STL")
        ...
        self.jlc.lnks[3]['mesh_file'] = os.path.join(this_dir, "meshes", "IRB1100_4kg-475_OmniCore_rev03_Link03_CAD_j.sat_2.STL")
        ...
        self.jlc.lnks[4]['mesh_file'] = os.path.join(this_dir, "meshes", "IRB1100_4kg-475_OmniCore_rev03_Link04_CAD_j.sat_2.STL")
        ...
        self.jlc.lnks[5]['mesh_file'] = os.path.join(this_dir, "meshes", "IRB1100_4kg-475_OmniCore_rev03_Link05_CAD_j.sat_2.STL")
        ...
        self.jlc.lnks[6]['mesh_file'] = os.path.join(this_dir, "meshes", "IRB1100_4kg-475_OmniCore_rev03_Link06_CAD_j.sat_2.STL")
...
if __name__ == '__main__':
    ...
    manipulator_instance = IRB1100(enable_cc=True)
