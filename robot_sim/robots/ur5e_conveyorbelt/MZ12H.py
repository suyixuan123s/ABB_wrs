...
import robot_sim.manipulators.MZ12H_01.MZ12H_01 as rbt
import robot_sim.end_effectors.gripper.robotiq140.robotiq140 as hnd
import robot_sim.robots.robot_interface as ri
from panda3d.core import CollisionNode, CollisionBox, Point3


class MZ12H(ri.RobotInterface):

    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), name="MZ12HRobot", enable_cc=True):
        ...
        # arm_homeconf[1] = math.pi * 19 / 36
        # arm_homeconf[2] = -math.pi / 3
        # arm_homeconf[3] = math.pi / 2
        # arm_homeconf[4] = math.pi / 3
        arm_homeconf[0] = 0
        arm_homeconf[1] = math.pi / 4
        arm_homeconf[2] = math.pi / 4
        arm_homeconf[3] = 0
        arm_homeconf[4] = math.pi / 3
        self.arm = rbt.MZ12HArm(pos=self.base_stand.jnts[-1]['gl_posq'],
