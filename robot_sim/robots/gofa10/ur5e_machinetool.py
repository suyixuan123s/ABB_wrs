...
# import robot_sim.end_effectors.gripper.robotiqhe.robotiqhe as hnd
...
if __name__ == '__main__':
    ...
    robot_s.jaw_to(.02)
    robot_s.gen_meshmodel(toggle_tcpcs=False, toggle_jntscs=False, is_machine=False).attach_to(base)
