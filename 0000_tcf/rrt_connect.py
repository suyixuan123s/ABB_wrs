...
class RRTConnect(rrt.RRT):
    ...
    def plan(self,
        ...
        # self.roadmap_goal_list.add_node('goal', conf=goal_conf)
        ...
        for _ in range(max_iter):
            ...
            last_nid = self._extend_roadmap(component_name=component_name,
                                            ...
                                            conf=rand_conf,
                                            ext_dist=ext_dist,
                                            goal_conf=tree_a_goal_conf_list[1],
                                            obstacle_list=obstacle_list,
                                            otherrobot_list=otherrobot_list,
                                            animation=animation)
            ...
            if last_nid != -1:  # not trapped:
                ...
                last_nid = self._extend_roadmap(component_name=component_name,
                                                ...
                                                otherrobot_list=otherrobot_list,
                                                animation=animation)
                # last_nid_1 = self._extend_roadmap(component_name=component_name,
                #                                 roadmap=tree_b_list[1],
                #                                 conf=tree_a.nodes[last_nid]['conf'],
                #                                 ext_dist=ext_dist,
                #                                 goal_conf=tree_b_goal_conf,
                #                                 obstacle_list=obstacle_list,
                #                                 otherrobot_list=otherrobot_list,
                #                                 animation=animation)
                # last_nid_2 = self._extend_roadmap(component_name=component_name,
                #                                 roadmap=tree_b_list[2],
                #                                 conf=tree_a.nodes[last_nid]['conf'],
                #                                 ext_dist=ext_dist,
                #                                 goal_conf=tree_b_goal_conf,
                #                                 obstacle_list=obstacle_list,
                ...
                if last_nid == 'connection':
                    ...
                    goal_nid = last_nid
                    tree_a_goal_conf_list[1] = tree_b_list[1].nodes[goal_nid]['conf']
...
if __name__ == '__main__':
    ...
    path = rrtc.plan(component_name='all', start_conf=np.array([0, 0]), goal_conf=np.array([5, 10]),
                     goal_conf_list=[[5, 10], [10, 15], [0, 15]],
                     obstacle_list=obstacle_list,
