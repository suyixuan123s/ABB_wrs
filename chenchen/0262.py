...
def get_figure(gripper, target_pos):
    ...
    rot_x = np.array([[1, 0, 0],
                      [0, math.cos(math.pi / 180 * 0), -math.sin(math.pi / 180 * 0)],
                      [0, math.sin(math.pi / 180 * 0), math.cos(math.pi / 180 * 0)]])
    rot_y = np.array([[math.cos(math.pi / 2), 0, math.sin(math.pi / 2)],
                      [0, 1, 0],
                      [-math.sin(math.pi / 2), 0, math.cos(math.pi / 2)]])
    rot_z = np.array([[math.cos(math.pi / 180 * 0), -math.sin(math.pi / 180 * 0), 0],
                      [math.sin(math.pi / 180 * 0), math.cos(math.pi / 180 * 0), 0],
                      [0, 0, 1]])
    rel_rot = rot_z
    rel_rot = np.dot(rel_rot, rot_y)
...
if __name__ == '__main__':
    ...
    grabitembox = cm.CollisionModel("object/026262.stl", )
    ...
    # grabitembox.attach_to(base)
    #
    grabitembox = cm.CollisionModel("object/0262corner.stl", )
    grabitembox.set_pos(pos=[0, 0, 0])
    grabitembox.set_rgba([190 / 255, 78 / 255, 32 / 255, 0.2])
    grabitembox.attach_to(base)
    ...
    gripper_s.jaw_width(width=0.0375 * 2, height=0.22)
