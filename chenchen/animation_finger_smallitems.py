...
def get_linear_motion(gripper, start_pos, start_rot, end_pos, end_rot, moveinterval, finger):
    ...
    for i in range(len(path_pos_step)):
        ...
        rot = [[start_rot[0][0],start_rot[0][1],start_rot[0][2]],[start_rot[1][0],path_rot_step[i],-1*parameter*start_rot[0][0]],[start_rot[2][0],parameter,path_rot_step[i]*start_rot[0][0]]]
