...
if __name__ == '__main__':
    ...
    get_figure(gripper = gripper_s,target_pos=semicirclekey_target_pos, rot_list=semicirclekey_rot_list,rgba= [0,0.3,0,0.3])
    ...
    get_figure(gripper = dif_gripper_s2,target_pos=difnut_target_pos1, rot_list=difnut_rot_list1, rgba=[0.3, 0.3, 0.3, 0.3])
