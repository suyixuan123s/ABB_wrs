...
def get_figure(gripper, target_pos):
    ...
    # rot_z = np.array([[math.cos(-math.pi/4),-math.sin(-math.pi/4),0],
    ...
    rot_x = np.array([[1, 0, 0],
                      [0, math.cos(math.pi / 4), -math.sin(math.pi / 4)],
                      [0, math.sin(math.pi / 4), math.cos(math.pi / 4)]])
    rot_y = np.array([[math.cos(math.pi / 4), 0, math.sin(math.pi / 4)],
                      [0, 1, 0],
...
if __name__ == '__main__':
    ...
    gripper_s.jaw_width(width=0.07, height=0.22)
