...
File: Analyze_point_cloud_center_point.py
Description:
"""
...
# 点云文件路径
point_cloud_path = r'E:\ABB-Project\ABB_wrs\suyixuan\ABB\Pose_Estimation\Task8_STL_To_Point_Cloud\Datasets\stl_to_point_cloud_voxelization1.ply'
...
# # 显示点云（保留原始颜色）
# o3d.visualization.draw_geometries([point_cloud_dataset], window_name="Colored Point Cloud", width=800, height=600)
