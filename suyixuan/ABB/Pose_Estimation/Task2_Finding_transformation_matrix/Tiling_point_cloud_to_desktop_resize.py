...
from robot_sim.robots.gofa5.gofa5 import GOFA5  # 导入 Task5_ICP_GOFA5.py 中的机器人模型
...
def main():
    ...
    # 加载点云
    pcd_path = r"E:\ABB-Project\ABB_wrs\suyixuan\ABB\depth_anything_v2\Point_cloud_Dataset\color_image_20241211-100240.ply"  # 请更换为实际路径
    ...
    output_path_directory = r"E:\ABB-Project\ABB_wrs\suyixuan\ABB\Pose_Estimation\Task2_Finding_transformation_matrix\Point_Cloud_Datasets"
    os.makedirs(os.path.dirname(output_path_directory), exist_ok=True)
    file_name_without_extension = os.path.splitext(os.path.basename(pcd_path))[0]
    output_path = os.path.join(output_path_directory, f'cropped_{file_name_without_extension}.ply')
