...
try:
    while True:
        ...
        if key == 13:
            ...
            transformed_point_cloud = transform_point_cloud(point_cloud, transformation_camera_to_sim)
            ...
            # 裁剪点云，只保留仿真平台桌面范围内的点
            x_range = (0.61, 0.86)  # x 轴范围
            y_range = (0.08, 0.355)  # y 轴范围
            z_range = (-0.015, 0.12)  # z 轴范围


            cropped_point_cloud = crop_point_cloud(transformed_point_cloud, x_range, y_range, z_range)

            # 保存路径
            save_path = r'../../ABB-11-6/Dataset/colored_point_cloud120302.ply'
