...
File: capture_chessboard_image.py
"""
    ...
    try:
        ...
        while captured_images < num_images:
            ...
            if key == 27:  # 按下 ESC 键退出
                ...
                # 保存彩色图像
                image_path = os.path.join(output_dir, f"chessboard_image_{captured_images}.png")
...
if __name__ == '__main__':
    output_directory = 'E:/ABB-Project/wrs-fujikoshi/ABB/Task2_Finding_transformation_matrix'
