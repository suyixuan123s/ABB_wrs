    ...
    try:
        while True:
            ...
            if key == 13:  # 如果按下回车键，开始处理点云
                ...
                # # 保存带颜色的点云到文件
                # o3d.io.write_point_cloud("../Point_cloud_files/output_point_cloud.ply", point_cloud_dataset)  # 保存点云为PLY格式文件
                # print("点云文件已保存: output_point_cloud.ply")  # 输出保存成功信息
                # break  # 退出循环，停止捕获

                # 保存带颜色的点云到文件
                o3d.io.write_point_cloud("../Point_cloud_files/demo24/output_point_cloud1111.ply",
