...
File: capture_point_cloud_By_Depth_Intrinsic_simulation.py
Description:
"""
...
try:
    while True:
        ...
        if key == 13:
            ...
            # # 将点云保存为 PLY 文件
            # o3d.io.write_point_cloud("../Point_cloud_files/colored_point_cloud.ply", point_cloud)
            # print("点云已保存为 colored_point_cloud.ply")
            #
            # break  # 生成点云后退出循环

            save_path = r'/suyixuan/Point_Cloud_Datasets/colored_point_cloud1118.ply'
