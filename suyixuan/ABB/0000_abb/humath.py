...
def distance_pnt2surface(surface, pnt):
    mod_d = surface[0]*pnt[0]+surface[1]*pnt[1]+surface[2]*pnt[2]+surface[3]
    mod_area = np.sqrt(np.sum(np.square([surface[0],surface[1],surface[2]])))
