...
# 点云文件路径
point_cloud_path = r'/suyixuan/ICP_Iterative_Closest_Point\colored_point_cloud1203.ply'
...
# E:\ABB-Project\ABB_wrs\venv\Scripts\python.exe E:\ABB-Project\ABB_wrs\suyixuan\ABB\ICP_Iterative_Closest_Point\Analyze_point_cloud.py
# 点云包含颜色信息，将显示带颜色的点云。
# 点的数量: 20379
# 中心点位置: [0.72657232 0.18167268 0.06010637]
