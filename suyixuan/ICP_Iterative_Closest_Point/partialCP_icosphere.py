...
if __name__ == '__main__':
    ...
    # name = "box12.STL"
    # obj = tw.TrimeshHu("./Object_Mesh/", name, scale=0.001)
    ...
    # 在一个顶点处生成大球
    gm.gen_sphere(sample[1], 0.03).attach_to(base)
    ...
    viewedmesh.export("temp4.stl")

    # 创建并显示生成的网格
    test = gm.GeometricModel("temp4.stl")
    test.set_rgba([1, 0, 0, 1])
    test.attach_to(base)
    # base.run()

    # 使用Open3D读取网格，计算法线，生成点云
    viewedmesh_o3d = o3d.io.read_triangle_mesh("Object_Mesh/temp4.stl")
    viewedmesh_o3d.compute_vertex_normals()
    pcd = viewedmesh_o3d.sample_points_poisson_disk(number_of_points=10000)
